...
@onready var resolution_option = $"../MarginContainer/VBoxContainer/HBoxContainer/VBoxContainer2/resolution option" as OptionButton
@onready var windowmode_option = $"../MarginContainer/VBoxContainer/HBoxContainer/VBoxContainer2/windowmode option" as OptionButton
